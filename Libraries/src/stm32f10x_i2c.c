...
/**
  ...
  *     @arg I2C_FLAG_ADDR: Address sent flag (Master mode) “ADSL?  *   Address matched flag (Slave mode)”ENDAD?  *     @arg I2C_FLAG_SB: Start bit flag (Master mode)
...
/**
  ...
  *     @arg I2C_IT_ADDR: Address sent flag (Master mode) “ADSL?  *                       Address matched flag (Slave mode)”ENDAD?  *     @arg I2C_IT_SB: Start bit flag (Master mode)
